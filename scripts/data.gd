...
const ZONE_KESSLER := {
	"id": "kessler", "name": "Kessler Belt", "hub": false, "map": Vector2(46, 34), "accent": Color("#F2A33A"),
...
const ZONE_HUB := {
	"id": "hub", "name": "The Hub", "hub": true, "colony": "Meridian Colony", "map": Vector2(50, 57), "accent": Color("#6BD69A"),
